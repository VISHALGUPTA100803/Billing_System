          ...
          {/* <div className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg">
                <p className="text-sm text-blue-600 dark:text-red-400">Total Amount</p>
              ...
              <div className="mb-8">
  <h2 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">Monthly Overview</h2>
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
    <div className="bg-gradient-to-r from-purple-500 to-indigo-600 p-6 rounded-xl shadow-lg">
      <p className="text-purple-100 text-lg">Total Amount</p>
      <p className="text-white text-3xl font-bold mt-2">₹{totalAmount.toFixed(2)}</p>
    </div>
    <div className="bg-gradient-to-r from-teal-500 to-emerald-600 p-6 rounded-xl shadow-lg">
      <p className="text-teal-100 text-lg">Monthly Budget</p>
      <p className="text-white text-3xl font-bold mt-2">₹{monthlyBudget.toFixed(2)}</p>
    </div>
  </div>
            </div>
