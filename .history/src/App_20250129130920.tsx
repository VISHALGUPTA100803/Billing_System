...
function App() {
  ...
  <p className="text-white text-xl sm:text-2xl font-bold">₹{totalAmount.toFixed(2)}</p>
</div>
  ...
  <p className="text-white text-xl sm:text-2xl font-bold">₹{monthlyBudget.toFixed(2)}</p>
</div>
